...
func (r *endpointRepoImpl) Create(endpoint *models.Endpoint) error {
	return r.db.Create(endpoint).Error
}

func (r *endpointRepoImpl) FindByID(id string) (*models.Endpoint, error) {
...
func (r *endpointRepoImpl) FindByProviderIDAndName(providerID string, name string) (*models.Endpoint, error) {
	var endpoint models.Endpoint
...
func (r *endpointRepoImpl) FindByProviderID(providerID string) ([]*models.Endpoint, error) {
	var endpoints []*models.Endpoint
	err := r.db.Where("provider_id = ?", providerID).Find(&endpoints).Error
	return endpoints, err
}

func (r *endpointRepoImpl) Update(endpoint *models.Endpoint) error {
	return r.db.Save(endpoint).Error
}

func (r *endpointRepoImpl) Delete(id string) error {
	return r.db.Where("id = ?", id).Delete(&models.Endpoint{}).Error
}
